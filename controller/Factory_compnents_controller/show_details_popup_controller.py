from view.Factory_compnents_view.show_details_popup_view import ShowDetailsPopupView
from model.Factory_compnents_model.show_details_popup_model import ShowDetailsPopupModel
