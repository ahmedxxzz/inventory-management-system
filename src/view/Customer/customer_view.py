...
class CustomerView(ctk.CTkFrame):
    def __init__(self, root):
        """create the customer main frame and adding navigation buttons
    ...
    def create_options_buttons(self):
        ...
        options = ['فاتورة', 'دفعة', 'مرتجع', 'حسابات المكاتب']
    ...
    def create_password_popup(self):
        ...
        cnl_btn =ctk.CTkButton(button_frame, text="إلغاء", command=lambda : popup.destroy())
