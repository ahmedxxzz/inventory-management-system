...
class ShowDetailsPopupView(ctk.CTkToplevel):
    ...
    def create_bottom_frame(self, operation_type):
        ...
        if operation_type == 'فاتورة شراء':
            ...
            self.tree_columns = ( 'amount_money', 'fac_money_before')
            self.tree_headers = ['المبلغ', 'حساب المصنع قبل الدفع']
        ...
        if operation_type == 'فاتورة شراء':
            ...
            self.tree.column('fac_money_before', width=100, anchor='center')
