...
class ExtraCostView(ctk.CTkFrame):

    def __init__(self, root):
        """create the Extra Cost main frame
        ...
        self.wallet = StringVar(value='اختار الخزنة')
    ...
    def create_upper_frame(self):
        ...
        self.wallet_menu= ctk.CTkOptionMenu(entries_frame ,variable=self.wallet)
        self.wallet_menu.pack(side='top', padx=10, pady=10)
        ################################################
    ...
    def create_bottom_frame(self):
        ...
        self.tree_columns = ('adds_types', 'date', 'amount_of_money', 'wallet_name')
        self.tree_headers = ['نوع التكاليف', 'تاريخ', 'المبلغ','نوع الخزنة']
        ...
        self.tree.column('adds_types',  anchor='center')
        self.tree.column('date', anchor='center')
        self.tree.column('amount_of_money',  anchor='center')
