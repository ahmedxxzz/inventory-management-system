...
class ReturnView(ctk.CTkFrame):
    ...
    def create_upper_frame(self):
        ...
        for i, (text, var) in enumerate(zip(lbls_names, entry_variables)):
            ...
            entry = ctk.CTkEntry(upper_input_frame, textvariable=var, font=("Arial", 18, "bold"), width=200, height=40, justify='right' if var in [self.cus_name, self.reason] else 'left')
        ...
        # --- NEW ROW FOR DATE SELECTION (under سبب الاسترجاع) ---
