...
class ShowDetailsPopupView(ctk.CTkToplevel):
    ...
    def create_bottom_frame(self, operation_type):
        ...
        style.map('Treeview', background=[('selected', "#21b3e4")])
        ...
        if operation_type == 'شراء':
            ...
            self.tree_columns = ( 'amount_money', 'customer_money_before')
        ...
        if operation_type == 'شراء':
            ...
            self.tree.column('customer_money_before', width=100, anchor='center')
