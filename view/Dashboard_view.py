...
class DashboardView(ctk.CTkFrame):
    ...
    def create_scrollableframe(self):
        ...
        self.supplier_opt = ctk.CTkOptionMenu(self.scrollable_frame, values=['snow white', 'golden rose'], variable=self.supplier)
        self.supplier_opt.pack(side='top', padx=10, pady=20)
