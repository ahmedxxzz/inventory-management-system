...
class ReturnView(ctk.CTkFrame):
    ...
    def create_bottom_frame(self):
        ...
        self.tree_columns = ('factory_name', 'date', 'product_code', 'quantity', 'reason')
        self.tree_headers = ['السبب', 'الكمية', 'كود القطعة', 'التاريخ', 'اسم المصنع']
        ...
        self.tree.column('factory_name', width=100, anchor='center')
    ...
    def recommendation_focusIn(self, var, recommendation_type):
            for btn_text, amount_money in self.recommendations:
                ...
                button = ctk.CTkButton(frame,text=btn_text,width=100,  height=35,fg_color="#4CAF50", font=("Arial", 14),hover_color="#45a049",text_color="yellow",border_width=2,border_color="#388E3C", corner_radius=10,command=lambda btn_text=btn_text: var.set(btn_text))
    ...
    def clear_inputs(self):
        inputs = [self.fac_name, self.product_code, self.quantity, self.reason]
        for input in inputs:
            input.set('')
